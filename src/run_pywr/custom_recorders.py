...
class AnnualHydropowerRecorder(NumpyArrayNodeRecorder):
    ...
    def values(self):
        ...
        annual_hydropower = annual_hydropower.resample('Y').sum() # To get annual hydropower generation
...
# ======================================================================================
# Need to review all the recorders below
# ======================================================================================
...
class AverageAnnualCropYieldScenarioRecorder(NodeRecorder):
    ...
    def values(self):
        ...
        return self._temporal_aggregator.aggregate_2d(crop_yield.values, axis=0, ignore_nan=self.ignore_nan)
...
class SeasonalTransferConstraintRecorder(NodeRecorder):
    ...
    This rule is used for the Amu Darya River model to represent Nurek's historical operation
    """
